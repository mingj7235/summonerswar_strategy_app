...
import static com.joshua.summonerswar.global.enums.JwtExpirationEnums.ACCESS_TOKEN_EXPIRATION_TIME;
...
public class JwtTokenUtil {
    ...
    private String doGenerateToken (String username, Long expireTime) {
        ...
        return Jwts.builder()
                .setClaims(claims)
                .setIssuedAt(new Date(System.currentTimeMillis())) //FIXME : yml Issuer check value
